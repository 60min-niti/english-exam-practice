...
## สถานะปัจจุบัน
- **Structure 1–8, Vocabulary 1–8, Reading 1–8 = 800 ข้อ** (ทุกข้อตรวจ QA ผ่าน)
...
## ฟีเจอร์ในแอป
ทำเต็มชุด 100 ข้อ (สุ่มชุดจาก 3 พาร์ท) / รายพาร์ท · โหมดสอบจับเวลา + โหมดฝึกเฉลยทันที · autosave-resume · หน้าเฉลย (ยกช้อยมาแสดง เฉลยสีเขียว คำแปลไทย กรองรายพาร์ท ไฮไลต์คำในบทความ) · สถิติ+กราฟ+จุดอ่อนรายแท็ก · ฝึกแยกตามหัวข้อ (tag) · สมุดข้อผิด (spaced repetition) · คลังคำศัพท์+เกมทายคำแปล · บุ๊กมาร์ก/โน้ตรายข้อ · export/import
