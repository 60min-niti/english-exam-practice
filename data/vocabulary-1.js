...
window.TUGET_DATA.push({
  ...
  questions: [
    // ===== Cloze: เลือกคำเติมช่องว่าง =====
    {
      ...
      choices: ["arise", "raise", "rise", "lift"],
      glosses: ["เกิดขึ้น (ปัญหา)", "ยก/สร้าง (มีกรรม)", "ลุกขึ้น/สูงขึ้น (ไม่มีกรรม)", "ยกขึ้น/ยกเลิก (มาตรการ)"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["agreement", "appointment", "achievement", "argument"],
      glosses: ["ข้อตกลง", "การนัดหมาย", "ความสำเร็จ", "การโต้เถียง"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["resulted", "caused", "affected", "led"],
      glosses: ["ส่งผล (ต้องใช้ result in)", "ก่อให้เกิด (มีกรรมตรง)", "ส่งผลกระทบต่อ", "นำไปสู่ (ต้องใช้ lead to)"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["toll", "fine", "fee", "fare"],
      glosses: ["ค่าผ่านทาง", "ค่าปรับ", "ค่าธรรมเนียม", "ค่าโดยสาร"],
      answer: 2,
    ...
    },
    {
      ...
      choices: ["curable", "reliable", "temporary", "permanent"],
      glosses: ["รักษาให้หายได้", "น่าเชื่อถือ", "ชั่วคราว", "ถาวร"],
      answer: 3,
    ...
    },
    {
      ...
      choices: ["postpone", "dismiss", "abandon", "prevent"],
      glosses: ["เลื่อนออกไป", "ไล่ออก/ปัดตก", "ล้มเลิก/ทอดทิ้ง (ถาวร)", "ป้องกัน"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["awarded", "permitted", "deserved", "entitled"],
      glosses: ["ได้รับการมอบ (รางวัล)", "ได้รับอนุญาตให้ (ทำ)", "สมควรได้รับ", "มีสิทธิ์ได้รับ (be entitled to)"],
      answer: 3,
    ...
    },
    {
      ...
      choices: ["informative", "tedious", "fascinating", "persuasive"],
      glosses: ["ให้ความรู้", "น่าเบื่อ ยืดยาด", "น่าหลงใหล", "โน้มน้าวใจเก่ง"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["mistake", "failure", "flaw", "error"],
      glosses: ["ความผิดพลาด (การกระทำ)", "ความล้มเหลว (ทั้งระบบ)", "ตำหนิ/จุดบกพร่อง (ในวัตถุ-ระบบ)", "ข้อผิดพลาด (การคำนวณ)"],
      answer: 2,
    ...
    },
    {
      ...
      choices: ["composition", "compartment", "component", "comparison"],
      glosses: ["การประพันธ์/ส่วนผสมโดยรวม", "ช่องเก็บของ", "ส่วนประกอบ", "การเปรียบเทียบ"],
      answer: 2,
    ...
    },
    {
      ...
      choices: ["accidentally", "collaboratively", "reluctantly", "separately"],
      glosses: ["โดยบังเอิญ", "อย่างร่วมมือกัน", "อย่างไม่เต็มใจ", "อย่างแยกกัน"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["impression", "income", "impulse", "impact"],
      glosses: ["ความประทับใจ", "รายได้", "แรงกระตุ้นชั่ววูบ", "ผลกระทบ (have an impact on)"],
      answer: 3,
    ...
    // ===== Synonym: เลือกคำที่ความหมายใกล้เคียงกับคำขีดเส้นใต้ =====
    {
      ...
      choices: ["distribute", "summarize", "ignore", "examine"],
      glosses: ["แจกจ่าย", "สรุปย่อ", "เพิกเฉย", "ตรวจสอบ"],
      answer: 3,
    ...
    },
    {
      ...
      choices: ["relieve", "identify", "prolong", "worsen"],
      glosses: ["บรรเทา", "ระบุ", "ยืดเวลา", "ทำให้แย่ลง"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["convincing", "accurate", "unclear", "detailed"],
      glosses: ["น่าเชื่อถือ", "แม่นยำ", "ไม่ชัดเจน กำกวม", "ละเอียด"],
      answer: 2,
    ...
    },
    {
      ...
      choices: ["occasionally", "mainly", "slightly", "formerly"],
      glosses: ["เป็นครั้งคราว", "โดยส่วนใหญ่ เป็นหลัก", "เล็กน้อย", "แต่ก่อน"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["false and misleading", "emotional and biased", "clear and detailed", "short and vague"],
      glosses: ["เท็จและชวนเข้าใจผิด", "เต็มอารมณ์และมีอคติ", "ชัดเจนและละเอียด เห็นภาพ", "สั้นและคลุมเครือ"],
      answer: 2,
    ...
    },
    {
      ...
      choices: ["possibly", "temporarily", "unavoidably", "rarely"],
      glosses: ["อาจจะ", "ชั่วคราว", "อย่างหลีกเลี่ยงไม่ได้", "แทบไม่"],
      answer: 2,
    ...
    },
    {
      ...
      choices: ["delicate", "filthy", "valuable", "heavy"],
      glosses: ["บอบบาง เปราะ แตกง่าย", "สกปรกมาก", "มีค่า", "หนัก"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["very poor", "unemployed", "very small", "uneducated"],
      glosses: ["ยากจนข้นแค้นมาก", "ตกงาน", "เล็กมาก", "ไม่มีการศึกษา"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["in person", "in advance", "with great care", "without delay"],
      glosses: ["ด้วยตนเอง", "ล่วงหน้า", "อย่างระมัดระวัง", "โดยไม่ชักช้า ทันที"],
      answer: 3,
    ...
    },
    {
      ...
      choices: ["prepared", "unable", "eager", "unwilling"],
      glosses: ["เตรียมพร้อม", "ทำไม่ได้ (ความสามารถ)", "กระตือรือร้น อยากทำ", "ลังเล ไม่เต็มใจ"],
      answer: 3,
    ...
    },
    {
      ...
      choices: ["polluted", "widened", "restored", "drained"],
      glosses: ["ทำให้เป็นมลพิษ", "ขยายให้กว้าง", "ฟื้นฟู (ตรงข้าม)", "ระบายน้ำออก"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["reliable", "recent", "audible", "loud"],
      glosses: ["หนักแน่น น่าเชื่อถือ", "เมื่อเร็ว ๆ นี้", "ที่ได้ยินได้", "เสียงดัง"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["gradual", "sudden", "successful", "peaceful"],
      glosses: ["ค่อยเป็นค่อยไป (ตรงข้าม)", "กะทันหัน ฉับพลัน", "สำเร็จ", "สงบสุข"],
      answer: 1,
