...
window.TUGET_DATA.push({
  ...
  questions: [
    // ===== Sentence Completion =====
    {
      ...
      choices: ["have upgraded", "upgrade", "will upgrade", "will have upgraded"],
      choicesTH: ["ได้ปรับปรุงแล้ว (ปัจจุบันสมบูรณ์)", "ปรับปรุง (ปัจจุบัน)", "จะปรับปรุง (อนาคต)", "จะปรับปรุงเสร็จแล้ว (อนาคตสมบูรณ์)"],
      answer: 3,
    ...
    },
    {
      ...
      choices: ["would buy", "buy", "will buy", "had bought"],
      choicesTH: ["คงซื้อ (เงื่อนไขแบบ 2)", "ซื้อ (ปัจจุบัน)", "จะซื้อ (อนาคต)", "ได้ซื้อแล้ว (อดีตสมบูรณ์)"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["compensated", "compensating", "to compensate", "compensate"],
      choicesTH: ["ชดเชยแล้ว (V3)", "การชดเชย (gerund)", "จะชดเชย (to V)", "ชดเชย (V1)"],
      answer: 2,
    ...
    },
    {
      ...
      choices: ["when", "what", "whose", "which"],
      choicesTH: ["ที่/เมื่อ (ใช้กับเวลา)", "สิ่งที่", "ซึ่ง...ของ", "ซึ่ง (ทำหน้าที่ประธาน/กรรม)"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["dumping", "have dumped", "is dumped", "dumps"],
      choicesTH: ["กำลังทิ้ง", "ได้ทิ้งแล้ว", "ถูกทิ้ง (รูปถูกกระทำ)", "ทิ้ง (รูปกระทำ)"],
      answer: 2,
    ...
    },
    {
      ...
      choices: ["was", "had", "did", "that"],
      choicesTH: ["เป็น (อดีต)", "ได้ (อดีตสมบูรณ์)", "จึงได้ (สลับประธาน-กริยาช่วย)", "ว่า"],
      answer: 2,
    ...
    },
    {
      ...
      choices: ["a little", "a few", "less", "much"],
      choicesTH: ["เล็กน้อย (นับไม่ได้)", "ไม่กี่ (นับได้)", "น้อยกว่า", "มาก (นับไม่ได้)"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["Seen", "To see", "Seeing", "Having seen"],
      choicesTH: ["ถูกมองเห็น (ผู้ถูกกระทำ)", "เพื่อมองเห็น", "มองเห็น (ผู้กระทำ)", "เมื่อได้เห็นแล้ว"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["have been", "were", "are", "is"],
      choicesTH: ["ได้เป็น (พหูพจน์)", "เป็น (พหูพจน์ อดีต)", "เป็น (พหูพจน์)", "เป็น (เอกพจน์)"],
      answer: 3,
    ...
    },
    {
      ...
      choices: ["However", "Despite", "Therefore", "Because of"],
      choicesTH: ["อย่างไรก็ตาม", "ทั้งที่/แม้จะมี (+ วลีนาม)", "ดังนั้น", "เพราะ (+ วลีนาม)"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["change", "changed", "changing", "to change"],
      choicesTH: ["เปลี่ยน (V1 — ใช้กับกรรมที่เป็นคน)", "ถูกเปลี่ยน (V3)", "กำลังเปลี่ยน", "ที่จะเปลี่ยน"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["lesser", "the less", "less", "the least"],
      choicesTH: ["ด้อยกว่า", "ยิ่งน้อยลง (the + ขั้นกว่า)", "น้อยกว่า (ขาด the)", "น้อยที่สุด (ขั้นสูงสุด)"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["has been", "is", "will be", "had been"],
      choicesTH: ["ได้ถูก (ปัจจุบันสมบูรณ์)", "ถูก (ปัจจุบัน)", "จะถูก (อนาคต)", "ได้ถูก (อดีตสมบูรณ์ — สอดคล้องกาล)"],
      answer: 3,
