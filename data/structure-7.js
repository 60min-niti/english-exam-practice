...
window.TUGET_DATA.push({
  ...
  questions: [
    // ===== Sentence Completion =====
    {
      ...
      choices: ["launched", "will launch", "had launched", "launches"],
      choicesTH: ["ปล่อย (อดีต)", "จะปล่อย (อนาคต)", "ได้ปล่อยแล้ว (อดีตสมบูรณ์)", "ปล่อย (ปัจจุบัน)"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["were", "had been", "is", "has been"],
      choicesTH: ["เป็น (เงื่อนไขแบบ 2)", "ได้เป็น (เงื่อนไขแบบ 3)", "เป็น (ปัจจุบัน)", "ได้เป็น (ปัจจุบันสมบูรณ์)"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["book", "to book", "booking", "booked"],
      choicesTH: ["จอง (V1)", "ที่จะจอง (to V)", "การจอง (gerund)", "จองแล้ว (V3)"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["which", "that", "whose", "what"],
      choicesTH: ["ซึ่ง", "ที่", "ซึ่ง...ของมัน (แสดงความเป็นเจ้าของ)", "สิ่งที่"],
      answer: 2,
    ...
    },
    {
      ...
      choices: ["monitors", "is being monitored", "monitoring", "has monitored"],
      choicesTH: ["เฝ้าติดตาม (รูปกระทำ)", "กำลังถูกเฝ้าติดตาม (รูปถูกกระทำต่อเนื่อง)", "กำลังเฝ้าติดตาม", "ได้เฝ้าติดตามแล้ว"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["was", "had been", "have been", "were"],
      choicesTH: ["ถูก (เอกพจน์ อดีต)", "ได้ถูก (อดีตสมบูรณ์)", "ได้ถูก (ปัจจุบันสมบูรณ์)", "ถูก (พหูพจน์ อดีต)"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["similar", "same", "alike", "identical as"],
      choicesTH: ["คล้าย (similar to)", "เหมือน (ต้องมี the)", "เหมือนกัน (วางหลังกริยาเท่านั้น)", "เหมือนกับ (รูปผิด)"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["must", "would", "could", "might"],
      choicesTH: ["ต้อง (must not = ห้าม)", "คงจะ", "สามารถ", "อาจจะ"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["Devastating", "Devastated", "To devastate", "Devastate"],
      choicesTH: ["ทำให้พินาศ (ผู้กระทำ)", "ถูกทำให้พินาศ (ผู้ถูกกระทำ)", "เพื่อทำให้พินาศ", "ทำให้พินาศ (V1)"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["nevertheless", "as a result", "in contrast", "for example"],
      choicesTH: ["อย่างไรก็ตาม", "ผลที่ตามมาคือ", "ในทางตรงกันข้าม", "ตัวอย่างเช่น"],
      answer: 1,
    ...
    },
    {
      ...
      choicesTH: ["เป็น (มองเป็นกลุ่มที่สมาชิกแยกความเห็น → พหูพจน์ได้)", "เป็น (พหูพจน์)", "เป็น (รูปไม่ผัน)", "กำลังเป็น"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["to release", "releasing", "release", "released"],
      choicesTH: ["จะปล่อย (to V)", "การปล่อย (gerund)", "ปล่อย (V1)", "ปล่อยแล้ว (V3)"],
      answer: 1,
    ...
    },
    {
      ...
      choicesTH: ["ไม่มีสักอัน (ใช้กับ 3 ขึ้นไป)", "ไม่ทั้งสอง (ใช้กับ 2)", "อันใดอันหนึ่ง (ใน 2)", "ทั้งสอง"],
      answer: 1,
