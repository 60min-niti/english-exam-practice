...
window.TUGET_DATA.push({
  ...
  questions: [
    // ===== Sentence Completion =====
    {
      ...
      choices: ["is", "are", "have been", "were"],
      choicesTH: ["เป็น (เอกพจน์)", "เป็น (พหูพจน์)", "ได้เป็น (พหูพจน์ สมบูรณ์)", "เป็น (พหูพจน์ อดีต)"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["is expected", "expecting", "has expected", "expects"],
      choicesTH: ["ถูกคาดหวัง (รูปถูกกระทำ)", "กำลังคาดหวัง", "ได้คาดหวังแล้ว", "คาดหวัง (รูปกระทำ)"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["rose", "rise", "are rising", "have risen"],
      choicesTH: ["สูงขึ้น (อดีต)", "สูงขึ้น (ปัจจุบัน)", "กำลังสูงขึ้น (ปัจจุบันต่อเนื่อง)", "ได้สูงขึ้น (ปัจจุบันสมบูรณ์)"],
      answer: 3,
    ...
    },
    {
      ...
      choices: ["would have been", "would be", "will be", "had been"],
      choicesTH: ["คงได้ถูก (เงื่อนไขแบบ 3)", "คงเป็น (เงื่อนไขแบบ 2)", "จะเป็น (อนาคต)", "ได้เป็น (อดีตสมบูรณ์)"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["where", "whose", "what", "that"],
      choicesTH: ["ที่ซึ่ง (สถานที่)", "ซึ่ง...ของมัน", "สิ่งที่", "ซึ่ง/ที่ (ประธานของอนุประโยค)"],
      answer: 3,
    ...
    },
    {
      ...
      choices: ["expand", "expanding", "expanded", "to expand"],
      choicesTH: ["ขยาย (V1)", "การขยาย (gerund)", "ขยายแล้ว (V3)", "จะขยาย (to V)"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["ones", "them", "those", "that"],
      choicesTH: ["อัน ๆ", "พวกมัน (สรรพนามกรรม)", "พวกนั้น (แทนนามพหูพจน์)", "อันนั้น (แทนนามเอกพจน์)"],
      answer: 2,
    ...
    },
    {
      ...
      choices: ["can", "should", "must", "would"],
      choicesTH: ["สามารถ", "ควรจะ (แต่ไม่ได้ทำ)", "ต้อง (มั่นใจว่าเกิดขึ้น)", "คงจะ"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["Having written", "Writing", "To write", "Written"],
      choicesTH: ["เมื่อได้เขียนแล้ว", "กำลังเขียน (ผู้กระทำ)", "เพื่อเขียน", "ถูกเขียน (ผู้ถูกกระทำ)"],
      answer: 3,
    ...
    },
    {
      ...
      choices: ["Owing to", "So that", "In order to", "Although"],
      choicesTH: ["เนื่องจาก (+ วลีนาม)", "เพื่อที่จะ (+ ประโยค)", "เพื่อที่จะ (+ กริยา)", "แม้ว่า (+ ประโยค)"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["have", "has", "was", "did"],
      choicesTH: ["ได้ (พหูพจน์)", "ได้ (เอกพจน์)", "ถูก (อดีต)", "ได้ทำ (อดีต)"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["wore", "is wearing", "wear", "wears"],
      choicesTH: ["สวม (อดีต)", "กำลังสวม", "สวม (รูป subjunctive ไม่ผัน)", "สวม (เอกพจน์ ปัจจุบัน)"],
      answer: 2,
    ...
    },
    {
      ...
      choices: ["nor", "but", "or", "and"],
      choicesTH: ["ทั้งไม่ (คู่กับ neither)", "แต่", "หรือ (คู่กับ either)", "และ"],
      answer: 2,
