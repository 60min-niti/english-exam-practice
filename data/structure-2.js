...
window.TUGET_DATA.push({
  ...
  questions: [
    // ===== Sentence Completion =====
    {
      ...
      choices: ["had been conducted", "have conducted", "were conducting", "conducted"],
      choicesTH: ["ถูกทำมาแล้ว (รูปถูกกระทำ)", "ได้ทำแล้ว (ปัจจุบันสมบูรณ์)", "กำลังทำ (อดีตต่อเนื่อง)", "ทำ (อดีตธรรมดา)"],
      answer: 2,
      explanation: "เหตุการณ์ยาว (กำลังทำการทดลอง) ถูกขัดจังหวะด้วยเหตุการณ์สั้น (ไฟดับ) ในอดีต → เหตุการณ์ยาวใช้ <b>Past Continuous (were conducting)</b> คู่กับ Past Simple — ตัวเลือก 1 เป็นรูป Passive ซึ่งผิดเพราะนักเรียนเป็นผู้ทำการทดลองเอง"
    },
    {
      ...
      choices: ["will avoid", "would avoid", "had avoided", "would have avoided"],
      choicesTH: ["จะเลี่ยง (อนาคต)", "คงเลี่ยง (เงื่อนไขแบบ 2)", "ได้เลี่ยงแล้ว (อดีตสมบูรณ์)", "คงได้เลี่ยงไปแล้ว (เงื่อนไขแบบ 3)"],
      answer: 3,
    ...
    },
    {
      ...
      choices: ["has paid", "paid", "will pay", "pays"],
      choicesTH: ["ได้ให้แล้ว (ปัจจุบันสมบูรณ์)", "ให้ (อดีต — ใช้กับ wish)", "จะให้ (อนาคต)", "ให้ (ปัจจุบัน)"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["must be submitting", "must have submitted", "must submit", "must be submitted"],
      choicesTH: ["ต้องกำลังยื่น", "ต้องได้ยื่นไปแล้ว", "ต้องยื่น (รูปกระทำ)", "ต้องถูกยื่น (รูปถูกกระทำ)"],
      answer: 3,
    ...
    },
    {
      ...
      choices: ["whether they had finished", "did they finish", "that they finished", "have they finished"],
      choicesTH: ["ว่าพวกเขาทำเสร็จแล้วหรือไม่ (คำถามทางอ้อม)", "พวกเขาทำเสร็จไหม (คำถามตรง)", "ว่าพวกเขาทำเสร็จ", "พวกเขาทำเสร็จหรือยัง (คำถามตรง)"],
      answer: 0,
      explanation: "คำถามทางอ้อม (Indirect Question) ใช้ <b>whether/if</b> นำ และเรียงแบบ<b>ประโยคบอกเล่า</b> (ประธาน + กริยา) พร้อมถอยกาลเป็น Past Perfect → <b>whether they had finished</b> — ตัวเลือก 2 และ 4 เรียงแบบคำถามตรงซึ่งใช้ในประโยครายงานไม่ได้"
    },
    {
      ...
      choices: ["printing", "printed", "to print", "print"],
      choicesTH: ["กำลังพิมพ์", "ถูกพิมพ์ (ช่อง 3 — ใช้กับสิ่งของ)", "เพื่อพิมพ์", "พิมพ์ (กริยาช่อง 1)"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["Although", "Because", "Despite", "Whereas"],
      choicesTH: ["แม้ว่า (+ ประโยค)", "เพราะ", "ทั้งที่ (+ วลีนาม)", "ในขณะที่ (เปรียบต่าง)"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["to how get", "how they get", "how to get", "how getting"],
      choicesTH: ["รูปผิดไวยากรณ์", "พวกเขาไปอย่างไร", "จะไปอย่างไร (question word + to V)", "อย่างไรการไป (ผิดรูป)"],
      answer: 2,
    ...
    },
    {
      ...
      choices: ["small enough", "too small", "so small", "very small that"],
      choicesTH: ["เล็กพอที่จะ", "เล็กเกินกว่าจะ (too...to)", "เล็กมาก (ต้องมี that)", "เล็กมากจน (ผิดรูป)"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["neither", "not only", "both", "either"],
      choicesTH: ["ไม่ทั้งสอง (คู่กับ nor)", "ไม่เพียงแต่ (คู่กับ but also)", "ทั้งสอง (คู่กับ and)", "อย่างใดอย่างหนึ่ง (คู่กับ or)"],
      answer: 2,
    ...
    },
    {
      ...
      choicesTH: ["กำลัง (เอกพจน์)", "กำลัง (พหูพจน์ อดีต)", "ได้ (เอกพจน์ สมบูรณ์)", "กำลัง (พหูพจน์)"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["To exercising", "Exercised", "Exercise", "Exercising"],
      choicesTH: ["รูปผิด", "ออกกำลังกายแล้ว (ช่อง 3)", "ออกกำลังกาย (คำนาม/กริยา)", "การออกกำลังกาย (gerund เป็นประธาน)"],
      answer: 3,
    ...
    },
    {
      ...
      choicesTH: ["ขนาด (such + a + adj + นาม)", "มาก (so + adj เดี่ยว)", "เกินไป", "มาก (ไม่เข้าโครงสร้าง)"],
      answer: 0,
