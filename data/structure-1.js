...
window.TUGET_DATA.push({
  ...
  questions: [
    // ===== Sentence Completion =====
    {
      ...
      choices: ["have already moved", "had already moved", "were already moving", "already moved"],
      choicesTH: ["ได้ย้ายไปแล้ว (ปัจจุบันสมบูรณ์)", "ได้ย้ายไปแล้ว (อดีตสมบูรณ์)", "กำลังย้ายอยู่ (อดีตต่อเนื่อง)", "ย้ายไปแล้ว (อดีตธรรมดา)"],
      answer: 1,
      explanation: "เหตุการณ์ 'ย้ายไปที่สูง' เกิด<b>ก่อน</b>เหตุการณ์ในอดีตอีกเหตุการณ์ (ทีมกู้ภัยมาถึง) จึงต้องใช้ Past Perfect คือ <b>had already moved</b> — ตัวเลือก 1 (Present Perfect) ใช้เชื่อมอดีตกับปัจจุบัน ไม่ใช่อดีตกับอดีต ส่วนตัวเลือก 4 (Past Simple) ไม่แสดงลำดับก่อน-หลังเมื่อมี 'By the time' นำหน้า"
    },
    {
      ...
      choices: ["had received", "receives", "received", "will receive"],
      choicesTH: ["ได้รับมาแล้ว (อดีตสมบูรณ์)", "ได้รับ (ปัจจุบัน)", "ได้รับ (อดีต — เงื่อนไขแบบ 2)", "จะได้รับ (อนาคต)"],
      answer: 2,
    ...
    },
    {
      ...
      choicesTH: ["ซึ่ง...ของเขา (แสดงความเป็นเจ้าของ)", "ผู้ซึ่ง (ประธาน)", "ซึ่ง (สิ่งของ)", "ผู้ซึ่ง (กรรม)"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["builds", "is building", "is being built", "has built"],
      choicesTH: ["สร้าง (รูปกระทำ)", "กำลังสร้าง (รูปกระทำ)", "กำลังถูกสร้าง (รูปถูกกระทำ)", "ได้สร้างแล้ว (รูปกระทำ)"],
      answer: 2,
    ...
    },
    {
      ...
      choices: ["she met", "did she meet", "met she", "she did meet"],
      choicesTH: ["เธอทำได้ทัน (เรียงปกติ)", "เธอทำได้ทัน (สลับประธาน-กริยาช่วย)", "ทำทันเธอ (เรียงผิด)", "เธอทำได้ทันจริง ๆ (เน้นย้ำ)"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["make", "making", "made", "to make"],
      choicesTH: ["ทำ (กริยาช่อง 1)", "การทำ (gerund)", "ทำแล้ว (ช่อง 3)", "จะทำ (to-infinitive)"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["the greatest", "more greater", "the greater", "greater"],
      choicesTH: ["มากที่สุด (ขั้นสูงสุด)", "ยิ่งมากกว่า (ซ้ำซ้อนผิด)", "ยิ่งมากขึ้น (the + ขั้นกว่า)", "มากกว่า (ขาด the)"],
      answer: 2,
    ...
    },
    {
      ...
      choices: ["be", "was", "will be", "is"],
      choicesTH: ["เป็น (รูป subjunctive ไม่ผัน)", "เป็น (อดีต)", "จะเป็น (อนาคต)", "เป็น (ปัจจุบัน)"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["Having startled", "To startle", "Startling", "Startled"],
      choicesTH: ["เมื่อได้ทำให้ตกใจแล้ว", "เพื่อทำให้ตกใจ", "ทำให้ตกใจ (ผู้กระทำ)", "ถูกทำให้ตกใจ (ผู้ถูกกระทำ)"],
      answer: 3,
    ...
    },
    {
      ...
      choices: ["Even though", "Although", "Because of", "Despite"],
      choicesTH: ["ถึงแม้ว่า (+ ประโยค)", "แม้ว่า (+ ประโยค)", "เพราะ (+ วลีนาม)", "ทั้งที่/แม้จะมี (+ วลีนาม)"],
      answer: 3,
    ...
    },
    {
      ...
      choicesTH: ["เป็น (พหูพจน์ อดีต)", "เป็น (เอกพจน์ อดีต)", "เป็น (เอกพจน์ ปัจจุบัน)", "เป็นมาแล้ว (เอกพจน์ สมบูรณ์)"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["develop", "are developing", "have developed", "will have developed"],
      choicesTH: ["พัฒนา (ปัจจุบัน)", "กำลังพัฒนา (ปัจจุบันต่อเนื่อง)", "ได้พัฒนาแล้ว (ปัจจุบันสมบูรณ์)", "จะพัฒนาเสร็จแล้ว (อนาคตสมบูรณ์)"],
      answer: 3,
    ...
    },
    {
      ...
      choices: ["than", "when", "as", "then"],
      choicesTH: ["กว่า (คู่กับ no sooner)", "เมื่อ (คู่กับ hardly)", "ขณะที่", "แล้วก็ (คำวิเศษณ์)"],
      answer: 0,
