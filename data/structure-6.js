...
window.TUGET_DATA.push({
  ...
  questions: [
    // ===== Sentence Completion =====
    {
      ...
      choices: ["had been excavating", "excavate", "have excavated", "excavated"],
      choicesTH: ["ได้ขุดสำรวจมาอย่างต่อเนื่อง (อดีตสมบูรณ์ต่อเนื่อง)", "ขุดสำรวจ (ปัจจุบัน)", "ได้ขุดสำรวจแล้ว (ปัจจุบันสมบูรณ์)", "ขุดสำรวจ (อดีต)"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["have lived", "lived", "live", "will live"],
      choicesTH: ["ได้อาศัยแล้ว", "อาศัย (อดีต — ใช้กับ wish)", "อาศัย (ปัจจุบัน)", "จะอาศัย"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["to access", "accessing", "access", "accessed"],
      choicesTH: ["ให้เข้าถึง (allow + กรรม + to V)", "การเข้าถึง", "เข้าถึง (V1)", "เข้าถึงแล้ว"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["took", "is taken", "takes", "will take"],
      choicesTH: ["ลงมือ (อดีต)", "ถูกลงมือ/ถูกดำเนินการ (รูปถูกกระทำ)", "ลงมือ (รูปกระทำ)", "จะลงมือ"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["whose", "it", "that", "which"],
      choicesTH: ["ซึ่ง...ของ", "มัน", "ที่", "ซึ่ง (the development of which)"],
      answer: 3,
    ...
    },
    {
      ...
      choicesTH: ["ทำ", "เป็น/กำลัง (is...evolving)", "ได้", "เป็น (อดีต)"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["moreover", "therefore", "however", "thus"],
      choicesTH: ["ยิ่งไปกว่านั้น", "ดังนั้น", "อย่างไรก็ตาม (แสดงความขัดแย้ง)", "ด้วยเหตุนี้"],
      answer: 2,
    ...
    },
    {
      ...
      choices: ["Realizing", "Realize", "To realize", "Realized"],
      choicesTH: ["ตระหนัก (ผู้กระทำ)", "ตระหนัก (V1)", "เพื่อตระหนัก", "ถูกตระหนัก (ผู้ถูกกระทำ)"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["more promising", "promising", "the most promising", "as promising"],
      choicesTH: ["มีอนาคตสดใสกว่า (ขั้นกว่า)", "มีอนาคตสดใส", "มีอนาคตสดใสที่สุด (ขั้นสูงสุด)", "มีอนาคตสดใสเท่า"],
      answer: 2,
    ...
    },
    {
      ...
      choicesTH: ["จัดหา (เอกพจน์)", "จัดหา (V1)", "การจัดหา (gerund)", "จัดหาแล้ว (V3)"],
      answer: 2,
    ...
    },
    {
      ...
      choices: ["as well", "and also", "or", "but also"],
      choicesTH: ["เช่นกัน", "และยัง (รูปผิด)", "หรือ", "แต่ยัง (คู่กับ not only)"],
      answer: 3,
    ...
    },
    {
      ...
      choices: ["got", "gets", "is getting", "get"],
      choicesTH: ["พักผ่อน (อดีต)", "พักผ่อน (เอกพจน์)", "กำลังพักผ่อน", "พักผ่อน (รูป subjunctive ไม่ผัน)"],
      answer: 3,
