...
window.TUGET_DATA.push({
  ...
  questions: [
    // ===== Sentence Completion =====
    {
      ...
      choices: ["cleared", "had been clearing", "have cleared", "clear"],
      choicesTH: ["เคลียร์ (อดีต)", "ได้เคลียร์มาอย่างต่อเนื่อง (อดีตสมบูรณ์ต่อเนื่อง)", "ได้เคลียร์แล้ว (ปัจจุบันสมบูรณ์)", "เคลียร์ (ปัจจุบัน)"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["remains", "remained", "will remain", "would remain"],
      choicesTH: ["ยังคง (ปัจจุบัน)", "ยังคง (อดีต)", "จะยังคง (อนาคต)", "คงยังคง"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["have", "having", "be had", "to have"],
      choicesTH: ["มี (V1)", "การมี (gerund)", "ถูกมี", "ที่จะมี"],
      answer: 1,
    ...
    },
    {
      ...
      choicesTH: ["ผู้ซึ่ง (ประธาน)", "ซึ่ง...ของเขา (แสดงความเป็นเจ้าของ)", "ซึ่ง (สิ่งของ)", "ที่"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["will replace", "will have been replaced", "will be replacing", "have replaced"],
      choicesTH: ["จะแทนที่ (รูปกระทำ)", "จะถูกแทนที่เสร็จแล้ว (อนาคตสมบูรณ์ ถูกกระทำ)", "จะกำลังแทนที่", "ได้แทนที่แล้ว"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["Hardly", "No sooner", "Scarcely", "Rarely"],
      choicesTH: ["แทบจะไม่ (คู่กับ when)", "พอ...ก็...ทันที (คู่กับ than)", "แทบจะไม่ (คู่กับ when)", "ไม่บ่อยนัก"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["angrier", "the angrier", "the angriest", "more angry"],
      choicesTH: ["โกรธขึ้น", "ยิ่งโกรธขึ้น (the + ขั้นกว่า)", "โกรธที่สุด (ขั้นสูงสุด)", "โกรธมากขึ้น (รูปผิด)"],
      answer: 1,
    ...
    },
    {
      ...
      choicesTH: ["เป็น (ปัจจุบัน)", "เป็น (รูป subjunctive ไม่ผัน)", "เป็น (อดีต)", "จะเป็น (อนาคต)"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["Concluding", "Concluded", "To conclude", "Conclude"],
      choicesTH: ["สรุป (ผู้กระทำ)", "ถูกสรุป (ผู้ถูกกระทำ)", "เพื่อสรุป", "สรุป (V1)"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["on the other hand", "therefore", "likewise", "in addition"],
      choicesTH: ["ในทางกลับกัน/อีกด้านหนึ่ง", "ดังนั้น", "เช่นเดียวกัน", "นอกจากนี้"],
      answer: 0,
    ...
    },
    {
      ...
      choicesTH: ["ได้ (พหูพจน์)", "ได้ (เอกพจน์)", "เป็น (พหูพจน์)", "เป็น (พหูพจน์ อดีต)"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["made", "forced", "let", "had"],
      choicesTH: ["ทำให้ (made + V1 ไม่มี to)", "บีบบังคับให้ (force + to V)", "ปล่อยให้ (let + V1)", "ให้ (have + V1)"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["although", "despite", "because of", "unless"],
      choicesTH: ["แม้ว่า (+ ประโยค)", "ทั้งที่/แม้จะมี (+ วลีนาม)", "เพราะ (+ วลีนาม)", "เว้นแต่"],
      answer: 1,
