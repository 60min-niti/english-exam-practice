...
window.TUGET_DATA.push({
  ...
  questions: [
    // ===== Sentence Completion =====
    {
      ...
      choices: ["study", "studied", "have been studying", "had studied"],
      choicesTH: ["ศึกษา (ปัจจุบัน)", "ศึกษา (อดีต)", "ได้ศึกษามาอย่างต่อเนื่อง (ปัจจุบันสมบูรณ์ต่อเนื่อง)", "ได้ศึกษาแล้ว (อดีตสมบูรณ์)"],
      answer: 2,
    ...
    },
    {
      ...
      choices: ["if", "unless", "because", "in case"],
      choicesTH: ["ถ้า", "เว้นแต่/ถ้าไม่", "เพราะ", "เผื่อว่า"],
      answer: 1,
    ...
    },
    {
      ...
      choicesTH: ["ที่ (ห้ามใช้ในประโยคขยายแบบมีจุลภาค)", "ซึ่ง (ใช้กับสิ่งของ มีจุลภาค)", "ที่ซึ่ง (สถานที่ + ประโยคเต็ม)", "สิ่งที่"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["than", "when", "that", "as soon as"],
      choicesTH: ["กว่า (คู่กับ no sooner)", "เมื่อ (คู่กับ hardly)", "ว่า", "ทันทีที่"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["used to", "is used to", "uses to", "was used for"],
      choicesTH: ["เคย (ในอดีต)", "เคยชินกับ (be used to + V-ing)", "รูปผิด", "ถูกใช้เพื่อ"],
      answer: 1,
    ...
    },
    {
      ...
      choicesTH: ["คาด (ช่อง 1)", "การคาด (gerund)", "ให้คาด (require + กรรม + to V)", "ถูกคาด (ช่อง 3)"],
      answer: 2,
    ...
    },
    {
      ...
      choices: ["even if", "as if", "only if", "if only"],
      choicesTH: ["แม้ว่า", "ราวกับว่า (+ were)", "ก็ต่อเมื่อ", "ถ้าเพียงแต่"],
      answer: 1,
    ...
    },
    {
      ...
      choicesTH: ["จำนวนมาก (นับได้)", "เล็กน้อย (นับได้)", "ส่วนมาก (นับไม่ได้)", "หลาย (นับได้)"],
      answer: 2,
    ...
    },
    {
      ...
      choicesTH: ["ต่อ", "กับ", "กับ/อยู่กับ (depend on)", "สำหรับ"],
      answer: 2,
    ...
    },
    {
      ...
      choicesTH: ["นั่ง/ใช้ (V1 — คู่กับ would rather)", "การนั่ง", "ที่จะนั่ง", "นั่ง (อดีต)"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["Checking", "Checked", "Having checked", "To check"],
      choicesTH: ["กำลังตรวจ (พร้อมกัน)", "ถูกตรวจ (ผู้ถูกกระทำ)", "เมื่อได้ตรวจแล้ว (เสร็จก่อน)", "เพื่อตรวจ"],
      answer: 2,
    ...
    },
    {
      ...
      choices: ["where is the registration office", "where the registration office is", "the registration office is where", "where does the registration office locate"],
      answer: 1,
      choicesTH: ["สำนักงานลงทะเบียนอยู่ที่ไหน (เรียงแบบคำถามตรง)", "สำนักงานลงทะเบียนอยู่ที่ไหน (เรียงแบบบอกเล่า — ถูก)", "เรียงผิดไวยากรณ์", "ใช้ locate ผิด + เรียงคำถามตรง"],
