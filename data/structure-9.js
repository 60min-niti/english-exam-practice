  ...
  questions: [
    {
      ...
      choicesTH: ["บอก (ใคร)", "พูด (อะไร)", "พูด/ใช้ภาษา", "พูดคุย"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["lend", "borrow", "loan", "owe"],
      choicesTH: ["ให้ยืม (lend somebody something)", "ขอยืม (borrow from)", "เงินกู้/ให้กู้ (ทางการ)", "เป็นหนี้"],
      answer: 0,
    ...
    },
    {
      ...
      choicesTH: ["เพิ่ม/ยก (มีกรรม)", "เพิ่มขึ้นเอง (ไม่มีกรรม)", "เกิดขึ้น (ปัญหา)", "ยกของขึ้น"],
      answer: 0,
    ...
    },
    {
      ...
      choicesTH: ["ผลกระทบ (คำนาม)", "ส่งผลต่อ (คำกริยา)", "ความรักใคร่", "มีประสิทธิภาพ (คำคุณศัพท์)"],
      answer: 0,
    ...
    },
    {
      ...
      choicesTH: ["ประหยัด คุ้มค่า", "เกี่ยวกับเศรษฐกิจ", "เศรษฐกิจ (คำนาม)", "วิชาเศรษฐศาสตร์"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["historic", "historical", "history", "historian"],
      choicesTH: ["สำคัญทางประวัติศาสตร์", "เกี่ยวกับประวัติศาสตร์ (ทั่วไป)", "ประวัติศาสตร์ (คำนาม)", "นักประวัติศาสตร์"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["sensible", "sensitive", "sensory", "sensual"],
      choicesTH: ["มีเหตุผล ฉลาดเลือก", "อ่อนไหว ไวต่อความรู้สึก", "เกี่ยวกับประสาทสัมผัส", "เย้ายวน"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["considerate", "considerable", "considering", "considered"],
      choicesTH: ["เอาใจใส่ผู้อื่น มีน้ำใจ", "มากมาย (ปริมาณ)", "เมื่อพิจารณาว่า", "ได้รับการพิจารณา"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["continuous", "continual", "continued", "continuing"],
      choicesTH: ["ต่อเนื่องไม่ขาดสาย", "เกิดซ้ำเป็นช่วงๆ (มีหยุด)", "ที่ดำเนินต่อ", "ที่กำลังดำเนินอยู่"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["lay", "lie", "lain", "lying"],
      choicesTH: ["วาง (มีกรรม)", "นอน/อยู่ (ไม่มีกรรม)", "นอน (ช่อง 3)", "กำลังนอน/โกหก"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["take", "bring", "fetch", "carry"],
      choicesTH: ["เอาไป (จากที่นี่ไปที่อื่น)", "เอามา (มาที่นี่)", "ไปเอา(ของ)มา", "แบก/พกพา"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["little", "few", "many", "several"],
      choicesTH: ["น้อย (นับไม่ได้)", "น้อย (นับได้)", "มาก (นับได้)", "หลาย (นับได้)"],
      answer: 0,
    ...
    },
    {
      ...
      choicesTH: ["จำนวน (นับได้)", "ปริมาณ (นับไม่ได้)", "ปริมาณ (นับไม่ได้)", "จำนวนมาก (a great deal of)"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["latter", "later", "latest", "last"],
      choicesTH: ["อันหลัง (ในสองสิ่ง)", "ทีหลัง (เวลา)", "ล่าสุด", "สุดท้าย"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["Besides", "Beside", "Aside", "Along"],
      choicesTH: ["นอกจาก (เพิ่มเติม)", "ข้างๆ (ตำแหน่ง)", "ไปด้านข้าง", "ตามไป"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["principle", "principal", "principally", "principled"],
      choicesTH: ["หลักการ ความเชื่อ (คำนาม)", "ครูใหญ่/หลัก (คุณศัพท์)", "โดยหลัก (กริยาวิเศษณ์)", "มีหลักการ (คุณศัพท์)"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["advice", "advise", "advised", "advisable"],
      choicesTH: ["คำแนะนำ (คำนาม)", "แนะนำ (คำกริยา)", "แนะนำแล้ว (อดีต)", "ควรทำ (คุณศัพท์)"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["except", "accept", "expect", "besides"],
      choicesTH: ["ยกเว้น", "ยอมรับ (กริยา)", "คาดหวัง (กริยา)", "นอกจาก...(ก็ยังมี)"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["ensure", "assure", "insure", "endure"],
      choicesTH: ["ทำให้แน่ใจ (ว่าสิ่งใดเกิด)", "รับรองกับคน (assure somebody)", "ทำประกันภัย", "อดทน"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["adapt", "adopt", "adept", "adapted"],
      choicesTH: ["ปรับตัว (adapt to)", "รับมาใช้/รับเลี้ยง", "เชี่ยวชาญ (คุณศัพท์)", "ปรับตัวแล้ว (อดีต)"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["complements", "compliments", "supplements", "implements"],
      choicesTH: ["เสริมให้สมบูรณ์/เข้ากัน", "ชมเชย", "เสริม/อาหารเสริม", "นำไปปฏิบัติ"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["stationary", "stationery", "stationed", "static"],
      choicesTH: ["อยู่นิ่ง ไม่เคลื่อนที่", "เครื่องเขียน (คำนาม)", "ประจำการ (ทหาร)", "นิ่ง/สถิต (เชิงเทคนิค)"],
      answer: 0,
    ...
    },
    {
      ...
      choices: ["proceed", "precede", "proceeds", "precedent"],
      choicesTH: ["ดำเนินต่อ", "มาก่อน/นำหน้า", "รายได้ (คำนาม)", "แบบอย่าง บรรทัดฐาน (คำนาม)"],
      answer: 0,
